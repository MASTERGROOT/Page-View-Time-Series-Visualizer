import unittest
import time_series_visualization
import matplotlib as mpl

class DataCleaningTestCase(unittest.TestCase):
    def test_data_cleaning(self):
        actual = len(time_series_visualization.df)
        expected = 1238
        self.assertEqual(actual, expected, "Expected DataFrame count after cleaning to be 1238.")
class LinePlotTestCase(unittest.TestCase):
    def setUp(self):
        self.fig = time_series_visualization.draw_line_plot()
...
class BarPlotTestCase(unittest.TestCase):
    def setUp(self):
        self.fig = time_series_visualization.draw_bar_plot()
        self.ax = self.fig.axes[0]
...
class BoxPlotTestCase(unittest.TestCase):
    def setUp(self):
        self.fig = time_series_visualization.draw_box_plot()
